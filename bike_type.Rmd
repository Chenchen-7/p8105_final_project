...
```{r}
ggsave(
  filename = "./results/monthly_ride_comparison.png",
  plot = total_ride,
  width = 10,
  height = 6,
  dpi = 300,
...
```{r}
ggsave(
  filename = "./results/average_duration.png",
  plot = avg_duration,
  width = 10,
  height = 6,
  dpi = 300,
...
```{r}
ggsave(
  filename = "./results/market_share.png",
  plot = mkt_share,
  width = 10,
  height = 6,
  dpi = 300,
...
```{r}
ggsave(
  filename = "./results/bike_preference.png",
  plot = user_bike_pref,
  width = 10,
  height = 6,
  dpi = 300,
...
```{r}
ggsave(
  filename = "./results/bike_type_preference.png",
  plot = ride_dur,
  width = 10,
  height = 6,
  dpi = 300,
...
```{r}
ggsave(
  filename = "./results/hourly_usage_pattern.png",
  plot = hourly_usage,
  width = 10,
  height = 6,
  dpi = 300,
